...
export const llmModels: LLMModel[] = [
  ...
  },
  {
    ...
    capabilities: ["Open Source", "Long Context", "Multilingual", "Efficient"],
    description: "Meta's latest 70B model matching 405B performance at much lower cost",
    strengths: ["Nearly matches Llama 3.1 405B", "Open source", "Great value", "Efficient"],
    weaknesses: ["Text-only (no multimodal)"],
    useCases: ["Cost-effective deployments", "Self-hosting", "General purpose", "Multilingual apps"],
    trainingCutoff: "2023-12",
  },
  {
    id: "mixtral-8x22b",
    ...
    capabilities: ["Open Source", "MoE Architecture", "Multilingual", "Function Calling"],
    description: "Sparse MoE model with exceptional cost efficiency using only 39B active params",
    strengths: ["Cost efficient MoE", "Open source", "Strong math", "Multilingual"],
    weaknesses: ["Lower than competitors", "Smaller context than some models"],
    useCases: ["Cost-effective deployments", "Multilingual applications", "European deployments"],
    trainingCutoff: "2024-01",
  },
  {
    id: "gpt-4o-mini",
    ...
    capabilities: ["Multimodal", "Fast", "Affordable", "Vision"],
    description: "OpenAI's small efficient model - 60% cheaper than GPT-3.5 Turbo",
    strengths: ["Extremely affordable", "Fast", "Multimodal", "Beats Gemini Flash & Claude Haiku"],
    weaknesses: ["Less capable than GPT-4o"],
    useCases: ["High-volume applications", "Cost-sensitive deployments", "Real-time chat"],
    trainingCutoff: "2023-10",
  },
  {
    ...
    capabilities: ["Long Context", "Vision", "Code Generation", "Computer Use", "Agentic"],
    description: "Previous generation Sonnet with computer use capabilities and strong coding",
    strengths: ["Computer use", "Strong coding", "Vision", "Agentic capabilities", "200K context"],
    weaknesses: ["Superseded by 4.5 series"],
    useCases: ["Computer automation", "Coding tasks", "Agent applications", "Legacy deployments"],
    trainingCutoff: "2024-04",
  },
  {
    ...
    capabilities: ["Reasoning", "Thinking Mode", "Long Context", "Multimodal", "Fast"],
    description: "Experimental reasoning model with thinking mode for complex problems",
    strengths: ["Strong reasoning", "1M context", "Thinking mode reduces hallucinations", "Very affordable"],
    weaknesses: ["Experimental", "Slower in thinking mode"],
    useCases: ["Complex reasoning", "Scientific problems", "Long document analysis", "Research"],
    trainingCutoff: "2024-08",
  },
  {
    ...
    capabilities: ["Code Generation", "MoE Architecture", "128K Context", "Open Source"],
    description: "First open-source model to break 10% on SWEBench with exceptional coding",
    strengths: ["Best-in-class coding", "Open source", "Matches GPT-4 level", "Very affordable"],
    weaknesses: ["Lower general knowledge than dedicated LLMs"],
    useCases: ["Software development", "Code generation", "Debugging", "SWE tasks"],
    trainingCutoff: "2024-03",
  },
  {
    id: "codestral",
    ...
    capabilities: ["Code Generation", "80+ Languages", "Largest Context for Coding", "Open Source"],
    description: "Mistral's first coding model supporting 80+ programming languages",
    strengths: ["256K context (largest for coding)", "80+ languages", "Beats GPT-4 Turbo on code", "Open source"],
    weaknesses: ["Focused on code (lower general knowledge)"],
    useCases: ["Code generation", "Repository-level completion", "Multi-language projects", "IDE integration"],
    trainingCutoff: "2024-03",
  },
  {
    id: "llama-3-1-8b",
    ...
    capabilities: ["Open Source", "Efficient", "Long Context", "Multilingual"],
    description: "Meta's smallest efficient model - SOTA for its size",
    strengths: ["Extremely efficient", "Open source", "Beats Mistral 7B", "Very cheap", "Long context"],
    weaknesses: ["Limited capability vs larger models"],
    useCases: ["Edge deployment", "Resource-constrained environments", "High-volume budget apps"],
    trainingCutoff: "2023-12",
  },
  {
    ...
    capabilities: ["Code Generation", "Open Source", "Code Completion", "Multilingual"],
    description: "Current SOTA open-source code model matching GPT-4o coding capabilities",
    strengths: ["SOTA open coding model", "Matches GPT-4o", "Code completion excellence", "Multilingual"],
    weaknesses: ["Less known in West"],
    useCases: ["Code generation", "Repository completion", "Chinese language coding", "Code repair"],
  ...
  },
  {
    ...
    capabilities: ["Open Source", "Multilingual", "Code", "Math", "Long Context"],
    description: "Alibaba's second generation 72B model with strong multilingual support",
    strengths: ["Open source", "Strong Chinese support", "Good coding", "Math capabilities"],
    weaknesses: ["Superseded by Qwen2.5 and Qwen3"],
    useCases: ["Chinese applications", "Multilingual deployments", "Open-source hosting"],
    trainingCutoff: "2024-03",
  },
]
