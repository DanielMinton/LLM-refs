...
export const llmModels: LLMModel[] = [
  {
    ...
    capabilities: ["Long Context", "Vision", "Code Generation", "Analysis", "Creative Writing"],
    description: "Most capable model from Anthropic with exceptional reasoning and coding abilities",
    strengths: ["Complex reasoning", "Long-form writing", "Code generation", "Safety"],
    weaknesses: ["Higher cost", "Slower response times"],
    useCases: ["Research", "Advanced coding", "Content creation", "Data analysis"],
  ...
  },
  {
    ...
    capabilities: ["Long Context", "Vision", "Code Generation", "Fast Responses"],
    description: "Best balance of intelligence, speed, and cost from Anthropic",
    strengths: ["Coding excellence", "Fast responses", "Great value", "Extended context"],
    weaknesses: ["Slightly less creative than Opus"],
    useCases: ["Software development", "Technical writing", "API integration", "Automation"],
